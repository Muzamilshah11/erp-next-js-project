  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-lg font-medium text-foreground mb-2">Purchase Orders</p>
        <p className="text-muted-foreground">Coming soon - Create and track purchase orders</p>
      </motion.div>
    </motion.div>
  )
}
