  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="text-lg font-medium text-foreground mb-2">Suppliers</p>
        <p className="text-muted-foreground">Coming soon - Manage suppliers and purchase agreements</p>
      </motion.div>
    </motion.div>
  )
}
